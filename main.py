...
<script>
var orderSid=null, productSid=null;
...
function checkReady() {
  ...
  var ok = orderSid && productSid && s && st;
...
function runProcess() {
  ...
  xhr.send(JSON.stringify({
    order_session: orderSid,
    product_session: productSid,
    store: store,
    staff: staff
  }));
}
